...
public class ParentViewAdapter_ParentFilter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HelpingHand.ParentViewAdapter+ParentFilter, HelpingHand", ParentViewAdapter_ParentFilter.class, __md_methods);
	}


	public ParentViewAdapter_ParentFilter ()
	{
		super ();
		if (getClass () == ParentViewAdapter_ParentFilter.class)
			mono.android.TypeManager.Activate ("HelpingHand.ParentViewAdapter+ParentFilter, HelpingHand", "", this, new java.lang.Object[] {  });
	}

	public ParentViewAdapter_ParentFilter (md50f0e548c1279eef0ff184f39bbb5a3f4.ParentViewAdapter p0)
	{
		super ();
		if (getClass () == ParentViewAdapter_ParentFilter.class)
			mono.android.TypeManager.Activate ("HelpingHand.ParentViewAdapter+ParentFilter, HelpingHand", "HelpingHand.ParentViewAdapter, HelpingHand", this, new java.lang.Object[] { p0 });
	}
