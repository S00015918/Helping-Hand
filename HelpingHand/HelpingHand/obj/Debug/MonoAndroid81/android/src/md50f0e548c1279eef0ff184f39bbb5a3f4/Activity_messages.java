...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HelpingHand.Activity_messages, HelpingHand", Activity_messages.class, __md_methods);
	}
	...
	public Activity_messages ()
	{
		...
		if (getClass () == Activity_messages.class)
			mono.android.TypeManager.Activate ("HelpingHand.Activity_messages, HelpingHand", "", this, new java.lang.Object[] {  });
	}
