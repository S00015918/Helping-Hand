...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HelpingHand.CreditCardFormatter, HelpingHand", CreditCardFormatter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == CreditCardFormatter.class)
			mono.android.TypeManager.Activate ("HelpingHand.CreditCardFormatter, HelpingHand", "", this, new java.lang.Object[] {  });
	}

	public CreditCardFormatter (android.widget.EditText p0)
	{
		super ();
		if (getClass () == CreditCardFormatter.class)
			mono.android.TypeManager.Activate ("HelpingHand.CreditCardFormatter, HelpingHand", "Android.Widget.EditText, Mono.Android", this, new java.lang.Object[] { p0 });
	}
